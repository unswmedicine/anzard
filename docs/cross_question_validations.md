...
special_rule_stim_1st      | STIM_1ST      | If stim_1st equals 'y' and iui_date=. then opu_date must be complete or can_date must be complete
...
special_rule_cycletype_2_don| CYCLE_TYPE   | If cycle_type = 2 & n_eggrec_fresh, n_embrec_fresh, n_s_egth, n_v_egth, n_s_clth, n_s_blth, n_v_clth & n_v_blth=0, then (at least one of n_eggdon_fresh or n_egfz_s or n_egfz_v or n_blfz_s, n_blfz_v, n_clfz_s or n_clfz_v >0)
special_rule_cycletype_2_rec| CYCLE_TYPE   | If cycle_type = 2 & n_eggdon_fresh,  n_efgz_s,  n_egfz_v, n_blfz_s, n_blfz_v, n_clfz_s & n_clfz_v=0 then  (at least one of n_eggrec_fresh or n_s_egth or n_v_egth or n_s_clth or n_s_blth or n_v_blth or n_v_clth >0) 
...
special_rule_sperm         | SP_QUAL       | If sp_site=e & sp_source=1 then sp_qual!=.
