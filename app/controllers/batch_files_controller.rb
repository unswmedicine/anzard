class BatchFilesController < ApplicationController
  ...
  def create
    ...
    # ToDo: Remove hot-fix association between batch file and user's first clinic (solved by adding clinic association to batch file corresponding to each clinic in CSV row)
