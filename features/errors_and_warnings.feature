Feature: Errors and Warnings
  ...
  Scenario: Not started yet is considered to be incomplete
    ...
    Then I should see "responses" table with
      | Cycle Id   | Registration Type | Created By  | Status      |
      | cycleid123 | survey            | Fred Bloggs | Incomplete |
  ...
  Scenario: Complete with warnings
    ...
    Then I should see "responses" table with
      | Cycle Id   | Registration Type | Created By  | Status                 |
      | cycleid123 | survey            | Fred Bloggs | Complete with warnings |
  ...
  Scenario: Complete
    ...
    Then I should see "responses" table with
      | Cycle Id   | Registration Type | Created By  | Status   |
      | cycleid123 | survey            | Fred Bloggs | Complete |
